...
@section('content')
    <div class="justify-content-center row">
        <div class="col-11 col-md-10 col-lg-8 col-xl-7">
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title">Crear administrador</h1>
                    ...
                    <form method="POST" action="{{ route('users.store') }}" class="needs-validation" novalidate>
                        ...
                        <div class="form-floating mt-3">
                            <input type="text" name="username" id="username"
                                ...
                                autocomplete="username" placeholder="{{ __('Username') }}" required maxlength="255"
                                autofocus />
                        ...
                        <div class="form-floating mt-3">
                            <input type="text" name="lastname" id="lastname"
                                ...
                                autocomplete="lastname" placeholder="{{ __('Lastname') }}" required maxlength="255" />
